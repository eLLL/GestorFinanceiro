...
public class RelatorioReceita extends javax.swing.JFrame
{
	 ...
	 * 
	 */
    private static final long serialVersionUID = -8034536822462621728L;
    ...
    private void initComponents()
    {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Relatório de Receitas",
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(RelatorioReceita.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RelatorioReceita().setVisible(true);
            }
        });
    }

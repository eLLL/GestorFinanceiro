...
public class SetupRemoveButtonDespesa implements ActionListener
{
    ...
    public static void setup(JTable tb_relatorio)
    {
        tb_relatorio.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseReleased(MouseEvent e)
            {
                ...
                {
                    JPopupMenu popup = new SetupRemoveButtonDespesa().createYourPopUp(rowindex, tb_relatorio);
    ...
    public void actionPerformed(ActionEvent event)
    {
        ...
        {
            int row = RelatorioDespesa.tb_relatorio.getSelectedRow();

            int selectedObject = (Integer) RelatorioDespesa.tb_relatorio.getModel().getValueAt(row, 1);
